...
void FAnimNode_OculusXREyeTracking::Evaluate_AnyThread(FPoseContext& Output)
{
	...
	const int32 LeftEyeIndex = BoneContainer.GetPoseBoneIndexForBoneName(LeftEyeBone);
	...
	const int32 RightEyeIndex = BoneContainer.GetPoseBoneIndexForBoneName(RightEyeBone);
