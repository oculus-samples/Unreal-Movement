...
struct OCULUSXRMOVEMENTUTILITY_API FOculusXRFaceExpressionModifierNew
{
	GENERATED_BODY()
public:
...
USTRUCT(BlueprintType)
struct OCULUSXRMOVEMENTUTILITY_API FOculusXRExpressionCurves
{
	GENERATED_BODY()
...
struct OCULUSXRMOVEMENTUTILITY_API FAnimNode_OculusXRFaceTracking : public FAnimNode_Base
{
	GENERATED_BODY()
